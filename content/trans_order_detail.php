                      ...
                      <table class="table table-bordered background-table">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo isset($row['update_at']) ? $row['update_at'] : ''  ?></td>
                                  <td>
                                      <!-- <a href="?page=tambah-instructor-major&id=" class="btn btn-primary">Add
                      major</a> -->
                                      <a href="?page=tambah-trans_order_detail&edit=<?php echo $row ['id']?>"
                                          class="btn btn-primary">Edit</a>
                                      <a onclick="return confirm('bener gak mau dihapus?')"
                                          href="?page=tambah-trans_order_detail&delete=<?php echo $row ['id']?>"
